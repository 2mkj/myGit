...
<table class="mytable">
  <tbody>
	 ...
	 <td><%--제목 --%>
	  ...
	  <td><div>
	  <img id="modifybtn" onclick="location.href='boardModify.bo'" src="image/mymainimg/modify.png" style="width:17px;height:17px">
...
<c:if test="${listcount == 0 && empty search_word}">
  <h3 style="color:gray; text-align:center; margin:100px 0;">등록된 댓글이 없습니다.</h3>
</c:if>
