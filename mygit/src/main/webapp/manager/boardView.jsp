		...
		<table class="table">
				...
				<tr>
					...
					<c:if test="${!empty boarddata.board_file}">
						...
						<td><img src="image/down.png" width="10px">
							<a href="BoardFileDown.boo?filename=${boarddata.board_file}">
			...
			<tr>
				<td colspan="2" class="center">
					<c:if test="${boarddata.board_name == id || id == 'admin'}"><%--작성자와 admin에게 수정 삭제 권한 함께 줌 --%>
