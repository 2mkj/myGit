 ...
 <thead>
   <tr>
    ...
    <tbody>
	 ...
	 <td><%--제목 --%>
	  <div>
	  	 <a href="BoardDetailAction.boo?num=${b.board_num}">
...
<div>
  ...
  <c:if test="${page < maxpage }">
	<c:url var="go" value="Community.co">
	  ...
	  <li class="page-item">
		<a href="boardList.boo?page=${page+1}&search_word=${search_word}">&gt;</a>
	  </li>
  </c:if>
</ul>
<br>
...
<!-- 검색 폼 영역 -->
<div>
  <input name="search_word" value="${search_word}"/>
