...
import community.CommunityAction;
import community.CommunityAddAction;
import community.CommunityDeleteAction;
import community.CommunityDetailAction;
import community.CommunityModifyAction;
import community.CommunityModifyView;
import community.CommunityWriteAction;
...
public class FrontController extends javax.servlet.http.HttpServlet {
	...
	protected void doProcess (HttpServletRequest request, HttpServletResponse response) 
		...
		case "/Community.net":
			...
			break;
		case "CommunityWrite.net":
			action = new CommunityWriteAction();
			break;
		case "/CommunityAddAction.net":
			action = new CommunityAddAction();
			break;
		case "/CommunityDetail.net":
			action = new CommunityDetailAction();
			break;
		case "/CommunityModifyView.net":
			action = new CommunityModifyView();
			break;
		case "/CommunityModifyAction.net":
			action = new CommunityModifyAction();
			break;
		case "/CommunityDelete.net":
